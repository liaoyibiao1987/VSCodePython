...
class EasyExcel(object):
    ...
    def __init__(self):
        ...
        self.m_filename = ''
        self.m_exists = False
        self.m_excel = win32com.client.DispatchEx(
            'Excel.Application')  #也可以用Dispatch，前者开启新进程，后者会复用进程中的excel进程
    ...
    def getRange(self, sheet, row1, col1, row2, col2):
        ...
        return sht.Range(
            self.getCell(sheet, row1, col1), self.getCell(sheet, row2, col2))
...
def loadConfig(configfile='import.ini'):
    '''parse config file'''
    global SPATH
    global DPATH
